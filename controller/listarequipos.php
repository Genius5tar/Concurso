            ...
            <table>
              <thead>
                <tr class="table100-head">
                  <th class="column1" width="10"  rowspan="4">ID</th>
                  <th class="column2">NOMBRE</th>
                  <th class="column3">CONFEDERACION</th>
                  <th class="column3">FECHA DE CALSIFICACION</td>
                  <th class="column5"></th>
                </tr>
              </thead>
              <tbody>
              ...
              ?>
                <tr>
                  <td class="column1"><?php echo $mostrar['id'];?></td>
                  <td class="column2"><?php echo $mostrar['nombre'];?></td>
                  <td class="column3"><?php echo $mostrar['confederacion'];?></td>
                  <td class="column3"><?php echo $mostrar['fecha'];?></td>
                  <td class="column5"></td>
                </tr>
                <?php  
                  }
