<section class="page-content">
      <section class="search-and-user">
        ...
        <script type="text/javascript"> var meses = new Array ("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"); var diasSemana = new Array("Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"); var f=new Date(); document.write(diasSemana[f.getDay()] + " " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear()); </script>
         ...
         <input type="text" disabled style=" background-color:transparent;">
        ...
        <div class="admin-profile">
          <span class="greeting" style="user-select: none;"><b>Hola</b> <?php echo $datos['nombres']; echo " "; echo $datos['apellidos'];?></span>
...
<header class="page-header">
  <nav class="none">
    <a href="https://eurostylesas.com/" aria-label="forecastr logo" class="logo"> 
        <img src="logo.png" alt="asasas" width="195" height="80"></img>
    </a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <button onclick="location.href='/EuroStyle_concurso/controller/cerrar_session.php'" class="collapse-btn" aria-expanded="true" aria-label="collapse menu">
          <svg aria-hidden="true">
